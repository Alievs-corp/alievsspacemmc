...
export function Login() {
  ...
  return (
    <div 
      className="h-screen flex justify-end items-center bg-cover bg-center"
      style={{ 
        backgroundImage: `url(${loginBg})`,
      }}
    >
      <div className="h-full flex items-center justify-end w-full md:w-1/2">
        <div 
          className="bg-[#13132F] h-full flex flex-col justify-center w-full md:rounded-tl-[30.6px] md:rounded-bl-[30.6px]"
          style={{
            borderTopLeftRadius: '0px',
            borderBottomLeftRadius: '0px',
            paddingTop: 'clamp(40px, 8vh, 94px)',
            paddingRight: 'clamp(20px, 5vw, 100px)',
            paddingBottom: 'clamp(40px, 8vh, 94px)',
            paddingLeft: 'clamp(20px, 5vw, 100px)',
          }}
        >
          <div className="flex justify-center items-center flex-col text-center mb-6 md:mb-8">
            <img 
              src={alievsspace} 
